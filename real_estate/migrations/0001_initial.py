    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alpha2code', models.CharField(max_length=2, primary_key=True, serialize=False)),
                ('flag', models.URLField(verbose_name='Flag Image')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='property_listings', to='real_estate.country')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
