...
# from .models import thailandPlaces, thailandShapes
...
# thailandShapes_shp = Path(__file__).resolve().parent / 'data' / 'tha_admbndl_admALL_rtsd_itos_20190221.shp'
# thailandPlaces_shp = Path(__file__).resolve().parent / 'data' / 'tha_admbndp_admALL_rtsd_itos_20190221.shp'
